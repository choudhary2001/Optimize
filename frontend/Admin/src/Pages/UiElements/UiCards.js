      ...
      <div className="page-content">
        <Container fluid={true}>
          ...
          <Row>
            <Col mg={6} xl={3}>
              <Card>
                <CardImg top className="img-fluid" src={img1} alt="OptiMize" />
                <CardBody>
            ...
            <Col mg={6} xl={3}>
              <Card>
                <CardImg top className="img-fluid" src={img2} alt="OptiMize" />
                <CardBody>
                  <CardTitle className="mt-0">Card title</CardTitle>
                  <CardText>
                    Some quick example text to build on the card title and make
            ...
            <Col mg={6} xl={3}>
              <Card>
                <CardImg top className="img-fluid" src={img3} alt="OptiMize" />
                <CardBody>
                  <CardText>
                    Some quick example text to build on the card title and make
                    up the bulk of the card&apos;s content.
            ...
            <Col md={6} xl={3}>
              <Card>
                ...
                <CardImg className="img-fluid" src={img4} alt="OptiMize" />
                <CardBody>
                  <CardText>
                    Some quick example text to build on the card title and make
                    up the bulk of the card&apos;s content.
          ...
          <Row>
            <Col lg={4}>
              <Card>
                <CardImg top className="img-fluid" src={img5} alt="OptiMize" />
                <CardBody>
                  <CardTitle className="mt-0">Card title</CardTitle>
                  <CardText>
            ...
            <Col lg={4}>
              <Card>
                ...
                <CardImg bottom className="img-fluid" src={img7} alt="OptiMize" />
              </Card>
            </Col>

            <Col lg={4}>
              <Card>
                <CardImg className="img-fluid" src={img6} alt="OptiMize" />
                <CardImgOverlay>
            ...
            <Col lg={6}>
              <Card>
                <Row className="no-gutters align-items-center">
                  <Col md={4}>
                    <CardImg className="img-fluid" src={img2} alt="OptiMize" />
                  </Col>
                  <Col md={8}>
                    <CardBody>
            ...
            <Col lg={6}>
              <Card>
                <Row className="no-gutters align-items-center">
                  ...
                  <Col md={4}>
                    <CardImg className="img-fluid" src={img3} alt="OptiMize" />
                  </Col>
                </Row>
              </Card>
            </Col>
            ...
            <Col className="col-12 mb-4">
              ...
              <CardDeck className="card-deck-wrapper">
                <div className="card-group">
                  <Card className="mb-4">
                    <CardImg top className="img-fluid" src={img4} alt="OptiMize" />
                    <CardBody>
                      <CardTitle className="mt-0">Card title</CardTitle>
                      <CardText>
                  ...
                  <Card className="mb-4">
                    <CardImg top className="img-fluid" src={img6} alt="OptiMize" />
                    <CardBody>
                      <CardTitle className="mt-0">Card title</CardTitle>
                      <CardText>
                        This is a wider card with supporting text below as a
