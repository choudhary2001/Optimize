...
const Register = () => {
    document.title = "Register | OptiMize ";
    return (
        <React.Fragment>
                            ...
                            <Col lg={6} md={8} xl={4}>
                                <Card className='mt-5'>
                                    <CardBody className="p-4">
                                        ...
                                        <p className="text-muted text-center mb-4">Get your free OptiMize account now.</p>
                                            ...
                                            <Row>
                                                <Col md={12}>
                                                    <div className="mb-4">
                                                        ...
                                                        <input type="text" className="form-control" id="first_name" placeholder="Enter username" defaultValue="admin@themesbrand.com" />
                                                    </div>
                                                    <div className="mb-4">
                                                        <label className="form-label" htmlFor="username">Last Name</label>
                                                        <input type="text" className="form-control" id="last_name" placeholder="Enter username" defaultValue="admin@themesbrand.com" />
                                                    </div>
                                                    <div className="mb-4">
                                                    ...
                                                    <div className="mb-4">
                                                        ...
                                                        <input type="password" className="form-control" id="password" placeholder="Enter password" defaultValue="123456" />
                                                    </div>
                                                    ...
                                                    <div className="d-grid mt-4">
                                                        <a href='#' className="btn btn-primary waves-effect waves-light" type="submit">Register</a>
                                                    </div>
                                                </Col>
                                            </Row>
                                        </form>
                                ...
                                <div className="mt-5 text-center">
                                    ...
                                    <p className="text-white-50">© {new Date().getFullYear()} OptiMize. Crafted with <i className="mdi mdi-heart text-danger"></i> by Swastik</p>
                                </div>
                            </Col>
                        </Row>
                    </Container>
