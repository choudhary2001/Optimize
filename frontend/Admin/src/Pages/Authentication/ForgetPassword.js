...
const ForgetPasswordPage = props => {
  ...
  document.title = "Forget Password | OptiMize ";
          ...
          <Row className="justify-content-center">
            <Col md={8} lg={6} xl={5}>
                  ...
                  <Row>
                    <Col xs={7}>
                      <div className="text-primary p-4">
                        ...
                        <p>Sign in to continue to OptiMize.</p>
                      </div>
                    </Col>
              ...
              <div className="mt-5 text-center">
                ...
                <p>
                  © {new Date().getFullYear()} OptiMize. Crafted with{" "}
                  <i className="mdi mdi-heart text-danger" /> by Swastik
                </p>
              </div>
            </Col>
          </Row>
